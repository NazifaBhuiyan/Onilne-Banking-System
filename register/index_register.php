...
<?php
   ...
   if(isset($_POST['btn'])){
	    ...
	    $cus_id = $_POST['customer_id'];
		 ...
		 $query="insert into customer values('$cus_id','$cus_name','$cus_street','$cus_city','$cus_DOB','$cus_Phno','$cus_email')"; 
...
<div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh">
    ...
    <h1 class="text-center p-3">REGISTER</h1>
        ...
        <button type="submit" class="btn btn-primary center" name="btn" value="submit">Register</button>
