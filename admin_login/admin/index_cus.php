...
<head>
   ...
   <!--<link rel='stylesheet' href='styles/style_cus.css' media='all' type='text/css'>
   CSS only -->
...
<?php
   if(isset($_POST['btn'])){
	   echo"<script>window.location='index_cusinsert.php'</script>";
   }
?>
...
<tr>
   ...
   <td><a class="btn btn-danger" href="index_delcus.php?id=<?php echo $row['customer_id'];?>">Delete</a></td>
</tr>
